...
public final class Definitions {
    public static List<Product> getProducts() {
        ...
        products.add(new Product("Apple","Fresh Apples", 1, new HealthyShop()));
        products.add(new Product("Oat Flakes","Gluten free Oat flakes", 1, new GlutenFreeShop()));
        products.add(new Product("Cereal bar","Extra energetic", 1, new ExtraFoodShop()));
